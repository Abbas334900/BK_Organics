...
// Corrected component name spelling for React conventions
const Products_Dashboard = () => {
  return (
    // 1. Removed outer padding/min-h-screen. This assumes
    //    it will be rendered inside your main Dashboard <Outlet />
    <>
      <h2 className="text-3xl font-bold mb-6 text-gray-800">Products Dashboard</h2>
      
      {/* 2. Added a border for a cleaner "card" look */}
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <thead className="bg-gray-50">
              <tr>
                {/* 4. Re-ordered columns for better UX */}
                <th
                  scope="col"
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {/* 5. Fixed mapping variable to singular 'product' */}
                ...
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <img
                      ...
                      alt={product.title}
                      className="w-12 h-12 object-cover rounded-md" // Made slightly smaller
                    />
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {/* 6. Fixed gap and button styles */}
                    <div className="flex items-center gap-2">
                      <Button
                        variant="outline"
                        size="icon"
                        // Removed custom className to use default shadcn styles
                      >
